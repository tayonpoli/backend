...
<html lang="en">
  <head>
    ...
    <title>[Admin] IndonesianFood</title>
  </head>
  <body>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-justify mt-5">
          <p style="color:rgb(247, 223, 91);font-size:20px">Overview</p>
          <h3 style="font-size:55px" class="font-weight-bold">A Little Information For Our Guest.</h3>
          <hr>
        ...
        <div class="row mb-3 mt-1 ">
          <div class="col-md-6 d-flex justify-content-end">
              <div style="margin-top:-0.5rem" class="card-img-overlay text-left">
               <a href="daftar_menu.php" class="btn btn-primary wlbtn gradient font-weight-bold">List Menu</a>
               <a style="margin-left:20px" href="pesanan.php" class="btn btn-primary wlbtn gradient font-weight-bold">Ordered List</a>
              </div>
            </div>
          </div>
  <!-- Akhir Menu -->
